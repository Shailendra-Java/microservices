...
public class UserMockMVCTest {
	...
	public void testBasicMVC() throws Exception {
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/ticket/")).andExpect(status().isOk())
				.andReturn();
	...
	public void testSingleUser() throws Exception {
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/ticket/user/100")).andExpect(status().isOk())
